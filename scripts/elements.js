    ...
    document.getElementById("headder").innerHTML = `
        <div class="headderContainer">
            <div class="headderColumn" style="width: fit-content;">
                <button onclick="window.location.href='/'" style="font-size: 350%; width: fit-content; max-width: 45%; background-color: #252525;"><img src="img/boltnogears.png" style="width: 15%;"> BoltBusterZ</button>
            </div>
        </div>`
}